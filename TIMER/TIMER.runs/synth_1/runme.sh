...
HD_PWD='C:/Users/retia/Documents/FACULTATE/ANUL1SEM2/PSN/TIMER/TIMER.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log timer_incercare_noua.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source timer_incercare_noua.tcl
